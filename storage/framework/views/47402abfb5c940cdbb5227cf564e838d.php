...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            class="absolute z-50 mt-2 <?php echo e($width); ?> <?php echo e($alignmentClasses); ?>"
            style="display: none;"
            @click="open = false">
        <div class="ring-1 ring-slate-200 <?php echo e($contentClasses); ?>">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\webreporthotel\resources\views/components/dropdown.blade.php ENDPATH**/ ?>