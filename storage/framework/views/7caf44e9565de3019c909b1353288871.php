        ...
        (function() {
            ...
            new Chart(document.getElementById('dailyChart'), {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        { label:'Selesai', data:<?php echo json_encode($chartData['completed']); ?>, borderColor:dimLine, backgroundColor:dimFill, pointRadius:3, pointBackgroundColor:dimLine, borderWidth:2, tension:0.35, fill:true }
                    ]
                },
                options: { 
                    responsive:true, 
            ...
            new Chart(document.getElementById('monthlyChart'), {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        { label:'Selesai', data:<?php echo json_encode($monthlyData['completed']); ?>, backgroundColor:isDark ? 'rgba(46,196,182,0.25)' : 'rgba(46,196,182,0.15)', borderRadius:8 }
                    ]
                },
                options: { 
                    responsive:true, 
            ...
            new Chart(document.getElementById('priorityChart'), {
                ...
                data: {
                    ...
                    datasets: [{ 
                        data:<?php echo json_encode(array_values($priorityStats)); ?>, 
